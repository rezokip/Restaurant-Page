...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"menuPageContent\": () => (/* binding */ menuPageContent)\n/* harmony export */ });\n/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.js */ \"./src/index.js\");\n/* harmony import */ var _menu_pic2_jpg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./menu-pic2.jpg */ \"./src/menu-pic2.jpg\");\n/* harmony import */ var _menu_pic3_jpg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./menu-pic3.jpg */ \"./src/menu-pic3.jpg\");\n/* harmony import */ var _menu_pic4_jpg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./menu-pic4.jpg */ \"./src/menu-pic4.jpg\");\n\n\n\n\n\n\n\nlet menuPageContent = function(){\n_index_js__WEBPACK_IMPORTED_MODULE_0__.page.domEl.textContent=''\nconst menupic1 = new Image()\nconst menupic2 = new Image()\nconst menupic3 = new Image()\nmenupic1.src = _menu_pic2_jpg__WEBPACK_IMPORTED_MODULE_1__\nmenupic2.src = _menu_pic3_jpg__WEBPACK_IMPORTED_MODULE_2__\nmenupic3.src = _menu_pic4_jpg__WEBPACK_IMPORTED_MODULE_3__\n\n\nconst menuImageContainer1 = new _index_js__WEBPACK_IMPORTED_MODULE_0__.ElementClass('div', _index_js__WEBPACK_IMPORTED_MODULE_0__.page, 'img-container')\nmenuImageContainer1.domEl.appendChild(menupic1)\nconst menuImageContainer2 = new _index_js__WEBPACK_IMPORTED_MODULE_0__.ElementClass('div', _index_js__WEBPACK_IMPORTED_MODULE_0__.page, 'img-container')\nmenuImageContainer2.domEl.appendChild(menupic2)\nconst menuImageContainer3 = new _index_js__WEBPACK_IMPORTED_MODULE_0__.ElementClass('div', _index_js__WEBPACK_IMPORTED_MODULE_0__.page, 'img-container')\nmenuImageContainer3.domEl.appendChild(menupic3)\n\n\nlet imgContainers = document.querySelectorAll('.img-container')\n\nfor(let i =0; i<imgContainers.length; i++){\n  imgContainers[i].style.display = 'none'\n}\n\nfunction renderImg(){\n  imgContainers[0].style.display = 'block'\n}\n\nrenderImg()\n\n\n\nfor(let i =0; i<imgContainers.length; i++){\n  \n  imgContainers[i].addEventListener('click', function(){\n \n    console.log(imgContainers[i]) \n    this.style.display = 'none'\n    if(i+1<imgContainers.length){\n      imgContainers[i+1].style.display = 'block' \n    }\n    else{\n      imgContainers[0].style.display = 'block'\n    }\n  })\n}\n\n}\n\n\n\n\n\n/*\nlet imgContainers = document.querySelectorAll('.img-container')\n\n\nfor(let i =0; i<imgContainers.length; i++){\n  imgContainers[i].style.display = 'none'\n}\n\nfunction renderImg(){\n  imgContainers[0].style.display = 'block'\n}\n\nrenderImg()\n\n\n\nfor(let i =0; i<imgContainers.length; i++){\n  \n  imgContainers[i].addEventListener('click', function(){\n \n    console.log(imgContainers[i]) \n    this.style.display = 'none'\n    if(i+1<imgContainers.length){\n      imgContainers[i+1].style.display = 'block' \n    }\n    else{\n      imgContainers[0].style.display = 'block'\n    }\n  })\n}\n*/\n\n//# sourceURL=webpack://restaurant-page/./src/menu.js?");
