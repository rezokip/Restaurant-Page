...
let homePageContent=function(){
  ...
  const wednesday = new ElementClass('p', openingHours, 'opening-hours-wednesday', 'Mittwoch: 12 Uhr - 21 Uhr')
  const thursday = new ElementClass('p', openingHours, 'opening-hours-thursday', 'Donnerstag: 12 Uhr - 21 Uhr')
  const friday = new ElementClass('p', openingHours, 'opening-hours-friday', 'Freitag: 12 Uhr - 22 Uhr')
  const saturday = new ElementClass('p', openingHours, 'opening-hours-saturday', 'Samstag: 12 Uhr - 22 Uhr')
  const sunday = new ElementClass('p', openingHours, 'opening-hours-sunday', 'Sonntag: 12 Uhr - 21 Uhr')
